...
public class Main {
    ...
    static int[] heroesHealth = {260, 280, 270, 300};
    static int[] heroesDamage = {20, 25, 15, 10};
    ...
    public static boolean[] medic {
        if (heroesSuperabilities[] = "medic");{
        if (heroesHealth [i] > 0) {
            if (heroesHealth[i] >=0  "+" "10") ;
            System.out.println("Hero is healed");
            return true;
        } else (heroesHealth[i] < 0) {
